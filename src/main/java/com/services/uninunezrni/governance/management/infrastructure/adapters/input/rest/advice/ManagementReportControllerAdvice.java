...
public class ManagementReportControllerAdvice {

    @ResponseStatus(HttpStatus.NOT_FOUND)
    @ExceptionHandler(ManagementReportNotFoundException.class)
    public ErrorResponse handleManagementReportNotFoundException () {
        return ErrorResponse.builder()
                .code(MANAGEMENT_REPORT_NOT_FOUND.getCode())
                .message(MANAGEMENT_REPORT_NOT_FOUND.getMessage())
    ...
    public ErrorResponse handleMethodArgumentNotValidException (MethodArgumentNotValidException exception) {
        ...
        return ErrorResponse.builder()
                .code(INVALID_MANAGEMENT_REPORT.getCode())
                .message(INVALID_MANAGEMENT_REPORT.getMessage())

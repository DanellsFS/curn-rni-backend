package com.services.uninunezrni.curriculum.infrastructure.adapters.output.persistence;

import com.services.uninunezrni.curriculum.application.ports.output.EicRegistrationPersistencePort;
import com.services.uninunezrni.curriculum.domain.model.EicRegistration;
import com.services.uninunezrni.curriculum.infrastructure.adapters.output.persistence.mapper.EicRegistrationPersistenceMapper;
import com.services.uninunezrni.curriculum.infrastructure.adapters.output.persistence.repository.EicRegistrationRepository;
